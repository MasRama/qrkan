...
const LegalController_1 = __importDefault(require("../app/controllers/LegalController"));
...
Route.get("/privacy-policy", LegalController_1.default.privacy);
Route.get("/terms-of-service", LegalController_1.default.terms);
